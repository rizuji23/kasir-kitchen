...
INSERT INTO "new_KitchenData" ("created_at", "id", "ip", "name_cashier", "no_billiard", "no_meja", "order_type", "updated_at") SELECT "created_at", "id", "ip", "name_cashier", "no_billiard", "no_meja", "order_type", "updated_at" FROM "KitchenData";
