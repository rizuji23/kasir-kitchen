...
INSERT INTO "new_KitchenData" ("created_at", "id", "ip", "name_cashier", "order_type", "updated_at") SELECT "created_at", "id", "ip", "name_cashier", "order_type", "updated_at" FROM "KitchenData";
